...
if not st.session_state['logged_in']:
    ...
    pages = ["Add Player","Player Statistics", "Data Summarization","Full Table" ]
    ...
    with st.sidebar.container():
        ...
        selected_cities = st.multiselect("City", options=player_data['city_area'].unique().tolist()) if 'city_area' in player_data.columns else []
